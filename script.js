window.addEventListener('load', function(){
    ...
    class Enemy {
        ...
        update() {
            this.spriteX = this.collisionX - this.width * 0.5;
            this.spriteY = this.collisionY - this.height + 45
    ...
    class Game {
        ...
        render(context, deltaTime){
            if (this.timer > this.interval){
                ...
                this.gameObjects = [...this.eggs, ...this.obstacles, 
                    this.player, ...this.enemies, ...this.hatchlings]
        ...
        init(){
            ...
            let attempts = 0;
            while (this.obstacles.length < this.numOfObstacles && 
                attempts < 500){
